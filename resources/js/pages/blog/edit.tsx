...
export default function BlogEdit({ post, categories }: Props) {
    ...
    return (
        <AdminLayout header={<h2 className="text-xl leading-tight font-semibold text-gray-800 dark:text-gray-200">Edit Artikel</h2>}>
            <Head title={`Edit Artikel - ${post.title}`} />
            ...
            <div className="flex flex-col gap-6 w-full">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground font-sans">Perbarui artikel blog "{post.title}".</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="rounded-lg border bg-background p-4 space-y-6">
                                    ...
                                    <div className="flex items-center justify-between rounded-lg border p-4 shadow-sm bg-muted/20">
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-xs text-muted-foreground font-sans">Tampilkan di halaman utama atau sorotan blog.</p>
                                        </div>
                                        <Switch
                                            id="is_featured"
                                    ...
                                    <div className="flex items-center justify-between rounded-lg border p-4 shadow-sm bg-muted/20">
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-xs text-muted-foreground font-sans">Artikel akan langsung terlihat di daftar blog publik.</p>
                                        </div>
                                        <Switch
                                            id="is_published"
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        <Button type="submit" disabled={processing}>
                            <Save className="mr-2 h-4 w-4" /> {processing ? 'Menyimpan...' : 'Perbarui Artikel'}
                        </Button>
                    </div>
                </form>
            </div>
