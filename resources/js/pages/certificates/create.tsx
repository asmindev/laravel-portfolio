...
export default function CertificatesCreate() {
    ...
    return (
        <AdminLayout header={<h2 className="text-xl leading-tight font-semibold text-gray-800 dark:text-gray-200">Tambah Sertifikat</h2>}>
            ...
            <div className="flex flex-col gap-6 w-full">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight font-sans">Tambah Sertifikat Baru</h1>
                            <p className="text-sm text-muted-foreground">Isi formulir di bawah untuk menambahkan sertifikasi atau penghargaan baru.</p>
                        </div>
                    </div>
                </div>
